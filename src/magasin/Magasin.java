...
{		
	public static void main(String[] args) {
		...
		float tpsLundi = factureDuLundi.getTps(); // Lecture l'objet  et remplissage de tpsLundi par factureDuLundi.tps
		//factureDuLundi.setTps(5);//Ecriture dans facture du lundi
